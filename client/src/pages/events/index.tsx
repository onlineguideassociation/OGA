...
import { CalendarDays, Users, Video, MapPin, Mic, Ticket, Building, ArrowRight } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div className="max-w-2xl">
              ...
              <h1 className="text-4xl font-bold text-slate-900 mb-2 tracking-tight">Global Industry Conferences & Networking</h1>
            ...
            <div className="flex flex-col gap-3 min-w-[200px]">
              <Button className="bg-indigo-600 hover:bg-indigo-700 text-white w-full">Host an Event</Button>
          ...
          <Card className="bg-slate-900 text-white border-none shadow-lg overflow-hidden relative">
            ...
            <CardContent className="p-8 md:p-12 relative z-10 flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-1 space-y-6">
                ...
                <h2 className="text-4xl md:text-5xl font-bold tracking-tight">AI & Global Tourism Summit 2026</h2>
                <p className="text-slate-300 text-lg max-w-xl">
                  The premier gathering for innovators at the intersection of artificial intelligence, sustainable hospitality, and travel tech.
                </p>
                <div className="flex flex-wrap gap-6 text-sm font-medium text-slate-300">
                  <span className="flex items-center gap-2"><CalendarDays className="h-5 w-5 text-indigo-400" /> Nov 12-14, 2026</span>
                  <span className="flex items-center gap-2"><MapPin className="h-5 w-5 text-indigo-400" /> Phnom Penh, Cambodia</span>
                  <span className="flex items-center gap-2"><Users className="h-5 w-5 text-indigo-400" /> 2,500+ Attendees</span>
                </div>
                <div className="flex gap-4 pt-4">
                  <Button className="bg-indigo-500 hover:bg-indigo-600 text-white border-none">Register Now</Button>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { title: "E-Commerce Automation Mastery", date: "Aug 24, 2026", type: "Webinar", category: "E-commerce", icon: Video, color: "text-blue-500" },
                  { title: "Fintech Integration for Hospitality", date: "Sep 10, 2026", type: "Hybrid", category: "Finance", icon: Users, color: "text-emerald-500" },
                  { title: "Sustainable Tourism Data Analytics", date: "Oct 05, 2026", type: "Virtual Workshop", category: "Technology", icon: Video, color: "text-amber-500" },
                  { title: "Logistics Optimization Summit", date: "Dec 02, 2026", type: "In-Person", category: "Logistics", icon: Building, color: "text-purple-500" }
                ].map((event, i) => (
                  <Card key={i} className="bg-white border-none shadow-sm hover:shadow-md transition-shadow group">
                    <CardContent className="p-6">
                      ...
                      <Button variant="ghost" className="w-full justify-between p-0 hover:bg-transparent hover:text-indigo-700">
            ...
            <div className="space-y-6">
              ...
              <Card className="bg-indigo-50 border-none shadow-sm">
                <CardContent className="p-6 text-center space-y-4">
                  ...
                  <Button className="w-full bg-indigo-600 hover:bg-indigo-700">Apply for Membership</Button>
                </CardContent>
              </Card>
            </div>
          </div>
